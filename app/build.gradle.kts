...
// Release signing is read from a gitignored keystore.properties so the repo
// still builds (debug) for anyone without the keystore. When present, the
// release build is signed with it.
